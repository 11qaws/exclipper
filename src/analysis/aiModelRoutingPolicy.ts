...
export const AI_BROADCAST_CONTEXT_ROUTING_REVISION = "1.11.0" as const;
...
const MAX_CONTEXT_EVENT_PEAKS = 12;
const EVENT_CONTEXT_DURATION_MS = 2 * 60_000;
const MAX_EVENT_TRANSCRIPT_REQUEST_HEADROOM =
  MAX_CONTEXT_EVENT_PEAKS *
  Math.ceil(EVENT_CONTEXT_DURATION_MS / QWEN_ASR_SAFE_CHUNK_DURATION_MS);
