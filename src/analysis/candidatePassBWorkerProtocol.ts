/** Google AI's official Gemini 2.5 Pro model identifier. */
export const CANDIDATE_PASS_B_MODEL_ID = "gemini-2.5-pro" as const;
export const CANDIDATE_PASS_B_MODEL_REVISION = "2.5-pro-07-2026" as const;
