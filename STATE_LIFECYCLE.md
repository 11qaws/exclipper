...
- 문서 버전: 0.3.0
- 기준 제품 계획: PRODUCT_PLAN.md 0.3.0
- 기준일: 2026-07-19 (Asia/Seoul)
- 적용 범위: GitHub Pages에서 실행되는 개인용 로컬 편집 어시스턴트와 선택형 CHZZK 로컬 수집기
...
| completed + ready | AI 분석 준비 완료 | 영상은 이 컴퓨터 안에서만 읽어요 | AI로 찾기 |
...
| running + connected | 채팅을 이 컴퓨터에 기록 중 · 마지막 저장 방금 | 안전하게 중지 |
...
모델 다운로드와 영상 업로드를 혼동하지 않도록 항상 “영상은 보내지 않아요”를 가까이 표시한다.
...
9. 모델 다운로드와 캐시는 네트워크 예외지만 영상·음성·채팅 업로드가 아니다. UI는 다운로드 전 크기 범위와 로컬 처리 사실을 설명한다.
